...
## Фаза 3: Реализация системы хранения изображений и фронтенда

- [ ] Реализовать шаблон index.html с drag & drop зоной загрузки
- [ ] Реализовать шаблон album.html с отображением изображений
- [ ] Добавить минимальный CSS для улучшения внешнего вида
- [ ] Добавить минимальный JavaScript для drag & drop загрузки
- [ ] Добавить функциональность копирования URL изображений
- [ ] Реализовать функции сохранения файлов в `storage.go`
- [ ] Создать систему генерации уникальных имен файлов
- [ ] Реализовать валидацию типов изображений (jpg, png, gif, webp)
- [ ] Добавить ограничение на размер загружаемых файлов
- [ ] Реализовать создание директории `/data` при запуске
- [ ] Добавить функции получения метаданных изображения

## Фаза 4: Реализация обработчиков загрузки
...
## Фаза 6: Реализация системы очистки
